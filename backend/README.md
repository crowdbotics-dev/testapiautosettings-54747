...
## Project Structure
    ...
    ├── testapiautosettings_54747  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_54747`
...
2. Clone this repo and `cd testapiautosettings_54747`
